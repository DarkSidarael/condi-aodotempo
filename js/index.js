...
const input = document.querySelector('#il');
...
form === null || form === void 0 ? void 0 : form.addEventListener('submit', (event) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const response = yield fetch(`https://api.openweathermap.org/data/2.5/weather?q=${localizacao}&appid=bec2ba569e90556198daccbc81bdd692&lang=pt_br&units=metric`);
